...
app.use('/categorias/ferreteria-cerrajeria', require('./router/categorias/ferreteria-cerrajeria'));
app.use('/categorias/heladeria', require('./router/categorias/heladeria'));
app.use('/categorias/hogar', require('./router/categorias/hogar'));
// ======= // 
app.use('/categorias/indumentaria', require('./router/categorias/indumentaria'));
app.use('/categorias/inmobiliaria', require('./router/categorias/inmobiliaria'));
app.use('/categorias/joyas-accesorios', require('./router/categorias/joyas-accesorios'));
app.use('/categorias/kiosco-golosinas', require('./router/categorias/kiosco-golosinas'));
// ======= // 
...
// ======= // 
app.use('/categorias/repuestos-accesorios', require('./router/categorias/repuestos-accesorios'));
...
// ======= // 
app.use('/categorias/souvenir-cotillon', require('./router/categorias/souvenir-cotillon'));
app.use('/categorias/supermercado', require('./router/categorias/supermercado'));
